      ...
      <div className="mt-4 mb-4">
        ...
        <div className="md:grid grid-cols-2">
          <div className="w4/6 m-4 text-left text-[#46666d]">
            <p className="mt-4 text-justify" data-aos="fade-down-right">
            ...
            <p className="mt-4 text-justify" data-aos="fade-up-right">
            ...
            <p className="mt-4 text-justify mb-4" data-aos="fade-down-left">
